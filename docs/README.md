# scalacheck-faker
[![Build](https://github.com/etspaceman/scalacheck-faker/actions/workflows/ci.yml/badge.svg)](https://github.com/etspaceman/scalacheck-faker/actions/workflows/ci.yml)
...
```scala
libraryDependencies += "io.github.etspaceman" %% "scalacheck-faker" % "@VERSION@"
```
...
## Faker Class
Another option for generating data is the @:source(src.main.scala.faker.Faker) class. This class
